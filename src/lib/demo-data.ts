...
export const workflows = [
  {
    ...
    description: "Discover, analyze, generate, approve, and publish content.",
    category: "Content",
    status: "active" as WorkflowStatus,
    runs: 1284,
    success: 98.4,
    updated: "2 min ago",
    nodes: ["Discover", "Analyze", "Generate", "Approval", "Publish"],
  },
  {
    id: "wf-research",
    name: "Competitive research brief",
    description: "Turn multiple sources into a cited bilingual market brief.",
    category: "Research",
    status: "active" as WorkflowStatus,
    runs: 486,
    success: 96.8,
    updated: "18 min ago",
    nodes: ["Search", "Extract", "Synthesize", "Review"],
  },
  {
    id: "wf-meeting",
    name: "Meeting action center",
    description: "Summarize meetings, identify owners, and sync action items.",
    category: "Operations",
    status: "draft" as WorkflowStatus,
    runs: 72,
    success: 94.1,
    updated: "Yesterday",
    nodes: ["Transcript", "Summarize", "Assign", "Sync"],
  },
];
...
export const executions = [
  {
    id: "RUN-2841",
    workflow: "Content intelligence pipeline",
  ...
  {
    id: "RUN-2839",
    workflow: "Meeting action center",
